  ...
  <xsl:template name="license-jurisdiction">
    ...
    <xsl:choose>
		...
		<xsl:choose>
               ...
               <xsl:when test="$license-locale='as' ">Generic</xsl:when>
               ...
               <xsl:when test="$license-locale='ru' ">Generic</xsl:when>
               ...
               <xsl:when test="$license-locale='lv' ">Generic</xsl:when>
            
               <xsl:when test="$license-locale='lt' ">Generic</xsl:when>
               ...
               <xsl:when test="$license-locale='uk' ">Generic</xsl:when>
            
               <xsl:when test="$license-locale='pt_BR' ">Generic</xsl:when>
               ...
               <xsl:when test="$license-locale='be' ">Generic</xsl:when>
               ...
               <xsl:when test="$license-locale='oci_ES' ">Generic</xsl:when>
            
               <xsl:when test="$license-locale='ast_ES' ">Generic</xsl:when>
               ...
               <xsl:when test="$license-locale='mn' ">Generic</xsl:when>
               ...
               <xsl:when test="$license-locale='ur' ">Generic</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Bulegetše Setšhaba</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='vi' ">()<xsl:copy-of select="$work_type"/> này được hiến vào() <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Phạm vi Công chúng</a>.()<xsl:copy-of select="$work_type"/> này được hiến vào() <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Phạm vi Công chúng</a>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Eskumen Publikora</a> eskaintzen da.</xsl:when>
            ...
            <xsl:when test="$license-locale='as' ">This <xsl:copy-of select="$work_type"/> is in the <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">eMphakathini</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='cs' "> <xsl:copy-of select="$work_type"/>byl/bylo přesunuto mezi <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">volná díla</a>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='ru' ">Это произведение (<xsl:copy-of select="$work_type"/>) находится в <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">общественном достоянии</a>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Dominio Público</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='nl' ">Er is een <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Publiek Domein verklaring</a> van toepassing op dit  <xsl:copy-of select="$work_type"/>.</xsl:when>
...
Important Reminder "The Creative Commons Public Domain License does not apply to the jurisdiction of Brazil. This option applies, for example, to works subject to American law. If your work is subject to Brazilian law, the "Public Domain" option will not have any legal effects regarding your work. For Brazil, you can use any other type of Creative Commons license, which have full force and effect under Brazilian law. You can choose these licenses at http://creativecommons.org/license/?lang=pt"
            ...
            <xsl:when test="$license-locale='hy' ">Այս<xsl:copy-of select="$ստեղծագործության_տեսակը"/> նվիրաբերված է<span class="translation-highlight-html">&amp;lt;a rel="license" href="http://creativecommons.org/licenses/publicdomain/"&amp;gt;</span>հանրությանը ի սեփականություն<span class="translation-highlight-html">&amp;lt;/a&amp;gt;</span>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Dominio Público</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='lv' ">This <xsl:copy-of select="$work_type"/> is in the <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>

       

            <xsl:when test="$license-locale='lt' ">Šis <xsl:copy-of select="$work_type"/> yra viešinamas kaip <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='es' ">Esta <xsl:copy-of select="$work_type"/> está en el <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Dominio Público</a>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">公共領域</a>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">公共領域 (Public Domain)</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='uk' ">This <xsl:copy-of select="$work_type"/> is in the <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>

       

            <xsl:when test="$license-locale='pt_BR' ">Este <xsl:copy-of select="$work_type"/> é dedicado à <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Domínio Público</a>.</xsl:when>

       

            <xsl:when test="$license-locale='hr' ">Ovo <xsl:copy-of select="$work_type"/> preneseno je u <a rel="license" href="http://creativecommons.org/licenses/publicdomain/deed.hr">javno dobro</a>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Dominio Público</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='be' ">Гэты твор (<xsl:copy-of select="$work_type"/>) знаходзіцца ў <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">грамадскім здабытку</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='oci_ES' ">This <xsl:copy-of select="$work_type"/> is in the <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>

       

            <xsl:when test="$license-locale='ast_ES' ">This <xsl:copy-of select="$work_type"/> is in the <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Domain Awam</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='mn' ">This <xsl:copy-of select="$work_type"/> is in the <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='sv' ">Detta <xsl:copy-of select="$work_type"/> skyddas inte av upphovsrätt <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">(Public Domain)</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='ur' ">This <xsl:copy-of select="$work_type"/> is in the <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='pl' "><xsl:copy-of select="$work_type"/> jest umieszczony w <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Domenie publicznej</a>.</xsl:when>
