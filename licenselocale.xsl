		...
		<xsl:choose>
         ...
         <xsl:when test="$jurisdiction='hk' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zh_TW' ">Hong Kong</xsl:when>
               ...
               <xsl:when test="$license-locale='he' ">Hong Kong</xsl:when>
         ...
         <xsl:when test="$jurisdiction='gt' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='th' ">Guatemala</xsl:when>
               ...
               <xsl:when test="$license-locale='he' ">Guatemala</xsl:when>
               ...
               <xsl:when test="$license-locale='zh_HK' ">Guatemala</xsl:when>
   ...
   <xsl:choose>
     ...
     <xsl:variable name="work_type_word">
       ...
       <xsl:choose>
           ...
           <xsl:when test="$license-locale='zh_HK' ">著作</xsl:when>
