    ...
    <xsl:choose>
         ...
         <xsl:when test="$jurisdiction='at' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">E-Austria</xsl:when>
         ...
         <xsl:when test="$jurisdiction='br' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">EBrazil</xsl:when>
         ...
         <xsl:when test="$jurisdiction='bg' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">EBulgaria</xsl:when>
         ...
         <xsl:when test="$jurisdiction='cn' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='en_US' ">Mainland China</xsl:when>
         ...
         <xsl:when test="$jurisdiction='co' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">EColombia</xsl:when>
         ...
         <xsl:when test="$jurisdiction='hu' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">EHungary</xsl:when>
         ...
         <xsl:when test="$jurisdiction='fi' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">EFinland</xsl:when>
         ...
         <xsl:when test="$jurisdiction='in' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='sv' ">India</xsl:when>
               ...
               <xsl:when test="$license-locale='se' ">Indien</xsl:when>
         ...
         <xsl:when test="$jurisdiction='it' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">E-Italy</xsl:when>
         ...
         <xsl:when test="$jurisdiction='kr' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">EKorea</xsl:when>
         ...
         <xsl:when test="$jurisdiction='my' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">EMalaysia</xsl:when>
         ...
         <xsl:when test="$jurisdiction='nl' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">ENetherlands</xsl:when>
         ...
         <xsl:when test="$jurisdiction='pt' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">EPortugal</xsl:when>
               ...
               <xsl:when test="$license-locale='se' ">Portugal</xsl:when>
         ...
         <xsl:when test="$jurisdiction='si' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">ESlovenia</xsl:when>
         ...
         <xsl:when test="$jurisdiction='se' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">ESweden</xsl:when>
         ...
         <xsl:when test="$jurisdiction='tw' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='zu' ">ETaiwan</xsl:when>
         ...
         <xsl:when test="$jurisdiction='us' ">
            ...
            <xsl:choose>
               ...
               <xsl:when test="$license-locale='sv' ">United States</xsl:when>
               ...
               <xsl:when test="$license-locale='se' ">Förenta Staterna</xsl:when>
      ...
      <xsl:choose>
        <xsl:when test="$derivs='n'">
          <xsl:choose>
              ...
              <xsl:when test="$license-locale='af' ">Geen Afgeleide Werke nie</xsl:when>
              ...
              <xsl:when test="$license-locale='nso' ">Ga go na Mošomo o Ntšhitšwego</xsl:when>
  ...
  <xsl:template name="thiswork">
	 ...
	 <xsl:otherwise>
      ...
      <xsl:choose>
            ...
            <xsl:when test="$license-locale='zu' ">Lolu <xsl:copy-of select="$work_type"/> lufakwa ilayisensi ngaphansi <a rel="license" href="{$license_url}">Kwelayisensi Lakwa <xsl:copy-of select="$license_name"/> </a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='sv' ">This <xsl:copy-of select="$work_type"/> is licensed under a <a rel="license" href="{$license_url}">Creative Commons <xsl:copy-of select="$license_name"/> License</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='se' ">Detta <xsl:copy-of select="$work_type"/> är licensierat under en <a rel="license" href="{$license_url}">Creative Commons <xsl:copy-of select="$license_name"/> Licens</a>.</xsl:when>
