  ...
  <xsl:template name="license-jurisdiction">
    ...
    <xsl:choose>
		...
		<xsl:choose>
               ...
               <xsl:when test="$license-locale='el' ">Generic</xsl:when>
               ...
               <xsl:when test="$license-locale='no' ">Generic</xsl:when>
               ...
               <xsl:when test="$license-locale='th' ">Generic</xsl:when>
...
<xsl:choose>
  ...
  <xsl:when test="contains($license_url, 'publicdomain')">
      ...
      <xsl:choose>
            ...
            <xsl:when test="$license-locale='el' ">This <xsl:copy-of select="$work_type"/> is dedicated to the <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>
...
Important Reminder "The Creative Commons Public Domain License does not apply to the jurisdiction of Brazil. This option applies, for example, to works subject to American law. If your work is subject to Brazilian law, the "Public Domain" option will not have any legal effects regarding your work. For Brazil, you can use any other type of Creative Commons license, which have full force and effect under Brazilian law. You can choose these licenses at http://creativecommons.org/license/?lang=pt"
            ...
            <xsl:when test="$license-locale='no' ">This <xsl:copy-of select="$work_type"/> is dedicated to the <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>
...
<a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Обществена Собственост</a>.</xsl:when>
            ...
            <xsl:when test="$license-locale='th' ">This <xsl:copy-of select="$work_type"/> is dedicated to the <a rel="license" href="http://creativecommons.org/licenses/publicdomain/">Public Domain</a>.</xsl:when>
